...
(15, 'http://www.tao.lu/middleware/taoqual.rdf#var_processinstance', 'http://www.w3.org/2000/01/rdf-schema#domain', 'http://www.tao.lu/middleware/taoqual.rdf#119010455660544', '', 'taoqual', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]'),
...
(15, 'http://www.tao.lu/middleware/taoqual.rdf#var_processinstance', 'http://www.w3.org/2000/01/rdf-schema#range', 'http://www.tao.lu/middleware/taoqual.rdf#119010455660544', '', 'taoqual', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]', 'yyy[admin,administrators,authors]'),

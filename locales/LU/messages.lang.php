...
$GLOBALS['__l10n']["Activity Editor"]="Aktivitéits Editor";
...
$GLOBALS['__l10n']["Deliveries library"]="Ausliwwerungs Sammlung";
$GLOBALS['__l10n']["Delivery"]="Ausliwwerung";
$GLOBALS['__l10n']["Delivery Class saved"]="Ausliwwerungsklass gespäichert";
...
$GLOBALS['__l10n']["Edit resultServer class"]="Editéier Resultatserver Klass";
...
$GLOBALS['__l10n']["Formal Parameter"]="Formal Parameter";
...
$GLOBALS['__l10n']["new result server"]="neie Resultatserver";
...
$GLOBALS['__l10n']["Please select a delivery before authoring it!"]="W.e.g. wielt eng Ausliwwerung aus virun der Editioun";
$GLOBALS['__l10n']["Process Property"]="Prozess Propriétéit";
...
$GLOBALS['__l10n']["Result Server class saved"]="Resultatserver Klass gespäichert";
$GLOBALS['__l10n']["Result Server saved"]="Resultatserver gespäichert";
$GLOBALS['__l10n']["Result Servers library"]="Resultatserver Sammlung";
...
$GLOBALS['__l10n']["Select delivery"]="Ausliwwerung wielen";
$GLOBALS['__l10n']["Select test takers to be <b>excluded</b>"]="Wielt d'Testkandidaten déi <b>ausgeschloss</b> solle ginn";
$GLOBALS['__l10n']["Selection saved successfully"]="Auswiel erfollegraich gespaichert";
$GLOBALS['__l10n']["Service Definition"]="Service Définitioun";
$GLOBALS['__l10n']["Test takers"]="Testpersounen";
$GLOBALS['__l10n']["Tests"]="Tester";
$GLOBALS['__l10n']["The Delivery module allows users to define tests delivery parameters."]="Den Ausliwwerungsmodul erlaabt de Benotzer Test Ausliwwerungs Parameter ze définéieren";
$GLOBALS['__l10n']["The format of this field is not valid."]="Den Format vun desem Datenfeld as nit valid.";
$GLOBALS['__l10n']["The Result Server Management section allows to add, edit and assign Delivery Result Server to Deliveries."]="D'Resultatserver Management Sektioun erlaabt Ausliwwerungs Resultat Serveren bäizefügen, ze editéieren oder matt Ausliwwerungen ze verbannen.";
$GLOBALS['__l10n']["The uploaded file is too large"]="De ropgeluedene Fichier as ze grouss";
$GLOBALS['__l10n']["This Delivery Management Section allows to add and delete deliveries and to edit their property values."]="Des Ausliwwerungs Management Sektioun erlaabt Ausliwwerungen bäizefügen oder ze läschen an hir Propriétéiten ze veränneren";

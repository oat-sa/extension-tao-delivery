...
/**
 * Installation action that register the authorization services and providers
 *
...
class RegisterAuthorizationService extends \common_ext_action_InstallAction
{
    ...
    public function __invoke($params)
    {
        ...
        $serviceManager->register(AuthorizationService::CONFIG_ID, new DeliveryAuthorizationService());
    }
}

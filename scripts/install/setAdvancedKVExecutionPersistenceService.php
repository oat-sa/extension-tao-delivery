...
use taoDelivery_models_classes_execution_AdvancedKVDeliveryExecution;
...
class setAdvancedKVExecutionPersistenceService extends \common_ext_action_InstallAction
{
    ...
    public function __invoke($params)
    {
        ...
        $deImplementation = new taoDelivery_models_classes_execution_AdvancedKVDeliveryExecution($persistence, '');
        $method = new \ReflectionMethod(taoDelivery_models_classes_execution_AdvancedKVDeliveryExecution::class,

...
$.widget("ui.draggable", $.extend({}, $.ui.mouse, {
	...
	mouseStart: function(e) {
		...
		var leftClick = xCoord - xOffset ;
		var vertClick = yCoord - yOffset ;
		
		
		this.offset.click = {left:leftClick,top:1};
	...
	init: function() {
		var self = this,
			...
			uiDialog = (this.uiDialog = uiDialogContainer.parent())
				...
				.attr('tabindex', -1).css('outline', 0).keypress(function(ev) {
					if (options.keyboard)
						options.keyboard(ev, self);
				})
				.mousedown(function() {
					self.moveToTop();
				}),
	...
	create: function(dialog) {
		...
		var $el = $('<div/>').appendTo(document.body)
			.addClass('ui-dialog-overlay').css($.extend({
				...
				width: this.width(),
				height: this.height()
			}, dialog.options.overlay)).click(function (e) { 

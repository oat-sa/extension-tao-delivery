...
require([appConfig],function(){require(["jquery"],function($){$("ul li").mouseover(function(){$("a .actionsBox .button",this).addClass("buttonSelected")}),$("ul li").mouseleave(function(){$("a .actionsBox .button",this).removeClass("buttonSelected")})})})}(),define("taoDelivery/controller/runtime/index",function(){}),define("taoDelivery/controller/template/editDelivery",["jquery","layout/section"],function($,section){return{start:function(){$("#compileLink").on("click",function(e){e.preventDefault(),section.loadContentBlock($(this).attr("href"))})}}}),define("taoDelivery/controller/testtaker",["jquery","i18n","helpers","module","layout/section","ui/feedback"],function($,__,helpers,module,section,feedback){function switchList(){var target,current=$(this).parent().attr("id");

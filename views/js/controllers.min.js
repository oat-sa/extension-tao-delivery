define("taoDelivery/controller/routes",[],function(){return{Delivery:{deps:"controller/deliveryAssembly",actions:{excludeTesttaker:"controller/testtaker"}}}}),define("taoDelivery/controller/deliveryAssembly",["jquery","i18n","helpers","ui/feedback","module"],function($,__,helpers,feedback,module){return{start:function(){var conf=module.config();conf.message&&feedback().info(conf.message),$("#saver-status").click(function(){var status=$('input[name="status"]:checked').val(),uri=$('input[name="assemblyUri"]').val();$.ajax({url:helpers._url("setStatus","Delivery","taoDelivery"),type:"POST",dataType:"text",data:{uri:uri,status:status},success:function(){feedback().success(__("Status saved")),$(".tree").trigger("refresh.taotree",[{selectNode:uri}])
},error:function(jqXHR,textStatus,errorThrown){feedback().error("Error occured: "+errorThrown)}})})}}}),function(t,e){"object"==typeof exports?module.exports=e():"function"==typeof define&&define.amd?define("spin",e):t.Spinner=e()}(this,function(){function o(t,e){var o,i=document.createElement(t||"div");for(o in e)i[o]=e[o];return i}function n(t){for(var e=1,i=arguments.length;i>e;e++)t.appendChild(arguments[e]);return t}function s(t,o,n,s){var a=["opacity",o,~~(100*t),n,s].join("-"),f=.01+n/s*100,l=Math.max(1-(1-t)/o*(100-f),t),u=i.substring(0,i.indexOf("Animation")).toLowerCase(),d=u&&"-"+u+"-"||"";return e[a]||(r.insertRule("@"+d+"keyframes "+a+"{0%{opacity:"+l+"}"+f+"%{opacity:"+t+"}"+(f+.01)+"%{opacity:1}"+(f+o)%100+"%{opacity:"+t+"}100%{opacity:"+l+"}}",r.cssRules.length),e[a]=1),a

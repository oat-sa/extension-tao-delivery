    ...
    <ul class="entry-point-box plain">
        <li>
            <a class="block entry-point entry-point-all-deliveries" href="<?=_url('index');?>">
                ...
                <?=__('Please try to launch an assessment with another web browser or operating system. If the problem still persists, contact your proctor or system administrator.');?>
                <div class="clearfix">
